...
public class BorderBottomTranslatorTest extends BorderTranslatorTests {
    private final BorderBottomTranslator translator = new BorderBottomTranslator();
    ...
    private void testBottomBorder(float size, CollapsedBorderValue bottom, BorderStyle expected) {
        BorderPropertySet propertySet = new BorderPropertySet(NONE_BORDER, NONE_BORDER, bottom, NONE_BORDER);
        propertySet.setBottom(size);
        ...
        assertEquals(expected, key.getBorderBottom());
    }
}