...
import com.github.ukase.toolkit.fs.IResourceSettings;
import com.github.ukase.toolkit.helpers.AbstractHandlebarsHelper;
import com.github.ukase.toolkit.pdf.*;
...
public class ResourceProvider {
    ...
    public Handlebars getEngine() {
        ...
        for (AbstractHandlebarsHelper<?> helper : context.getBeansOfType(AbstractHandlebarsHelper.class).values()) {
